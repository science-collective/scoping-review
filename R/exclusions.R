...
# TODO: Use ggcohort to track what is removed?
  data |>
    ...
    exclude(title, "open( |-|, )(textbooks?|doors?|education(al)?|seminar|learning|schools|course|book|pedagogy)") |>
    ...
    exclude(title, "open( |-)(datasets?|data sets?|data portal|data framework|data platform|data resource|data exploration)") |>
