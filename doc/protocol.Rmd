...
-   **Exclusion criteria**:
    ...
    -   Documents published >5 years in the past (defined as before 2017-01-01) to capture
...
a sample that each person can go through and manually
review them. In the interests of feasibility, a maximum for 4 books will
be selected and evaluated. Books will be selected based on consensus
...
topic list, and full length article including content relating to open collaboration. In addition to these variables, we
